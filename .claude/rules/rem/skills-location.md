...
**Why:** Skills live in the repo so they are version-controlled, reach every machine via
git, and survive cache clears. `setup.js` creates `~/.claude/skills → repo/skills/` and
